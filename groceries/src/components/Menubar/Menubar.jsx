  ...
  <div className="container">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className={active === "exploregrocery" ? "nav-link fw-bold active": "nav-link"} to="/exploregrocery" onClick={() => setActive('exploregrocery')}>Explore</Link>
        </li>
        <li className="nav-item">
      ...
      <div className="d-flex align-items-center gap-4">
        <Link to={`/cart`}>
          <div className="position-relative">
            <img src={assets.cart} alt="" height={38} width={38} className='position relative' />
          ...
          <>
            ...
            <button className="btn btn-outline-success btn-sm" onClick={() => navigate('/register')}>Register</button>
                ...
                <a href="" className="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                  <img src={assets.profile} alt="" width={38} height={38} className="rounded-circle" />
                </a>
